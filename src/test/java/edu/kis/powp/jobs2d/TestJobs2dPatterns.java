...
import edu.kis.powp.jobs2d.drivers.selectDrawingSecondFigure;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		selectDrawingSecondFigure selectDrawingSecondFigure =new selectDrawingSecondFigure(DriverFeature.getDriverManager());


        application.addTest("Figure Joe 1", selectTestFigureOptionListener);
		application.addTest("Figure Joe 2", selectDrawingSecondFigure);
		Rectangle rectangle=new Rectangle((DriverFeature.getDriverManager()));
