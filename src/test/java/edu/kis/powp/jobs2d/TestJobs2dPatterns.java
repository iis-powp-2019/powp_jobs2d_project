...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		SelectTestCustomFigureOptionListener triangle =
				new SelectTestCustomFigureOptionListener(DriverFeature.getDriverManager());

		SelectTestCustom2FigureOptionListener rectangle =
				new SelectTestCustom2FigureOptionListener(DriverFeature.getDriverManager());

		application.addTest("Figure Joe 1", selectTestFigureOptionListener);
		application.addTest("Figure Joe 2", selectTestFigure2OptionListener);
		application.addTest("Figure Jane", selectTestJaneFigureOptionListener);
		application.addTest("Figure Triangle", triangle);
		application.addTest("Figure Rectangle", rectangle);
	}
	...
	private static void setupDrivers(Application application) {
		...
		DriverFeature.addDriver("My Special Simulator", lineDrawerAdapter);
