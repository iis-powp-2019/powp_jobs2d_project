...
public class TestJobs2dPatterns {
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver testDriverBasic = new Jobs2dDriverToDrawerAdapter(DrawerFeature.getDrawerController());
		DriverFeature.addDriver("Basic Line Simulator", testDriverBasic);

		Job2dDriver testDriverDotted = new LineDrawerAdapter(LineFactory.getDottedLine());
		DriverFeature.addDriver("Dotted Line Simulator", testDriverDotted);
